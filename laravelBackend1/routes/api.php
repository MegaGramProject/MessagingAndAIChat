...
Route::middleware([CustomCorsMiddleware::class])->group(function () {
    ...
    Route::get('/getFilesForConvo/{convoid}', [aiconvoController::class, 'getFilesForConvo']);
    Route::post('/aiconvo', [aiconvoController::class, 'store']);
    Route::post('/aimessage', [aimessageController::class, 'store']);
    Route::post('/spokenAIMessage', [aimessageController::class, 'spokenVersionOfMessage']);
    Route::post('/sendFilesWithMessage', [aimessageController::class, 'sendFilesWithMessage']);
